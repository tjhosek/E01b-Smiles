...
arcade.draw_ellipse_filled(face_x - 33, face_y + 33, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + 33, face_y + 33, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x - 29, face_y + 43, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + 38, face_y + 43, 3, open_color.gray_2)
